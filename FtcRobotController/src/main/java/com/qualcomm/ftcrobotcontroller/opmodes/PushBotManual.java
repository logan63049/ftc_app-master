...

{
...

    {
        ...
        //
        float l_left_drive_power2 = scale_motor_power(-gamepad1.left_stick_y);
        float l_right_drive_power2 = scale_motor_power(-gamepad1.right_stick_y);

        set_drive_power_2 (l_left_drive_power2);
        set_drive_power_2 (l_right_drive_power2);
